...
export default function LobbyRoom({
  ...
  return (
    <>
      {/* PANEL JOIN */}
      <div className="rounded-2xl border-4 border-[#0c1c36] 
        ...
        <div className="mt-5 flex flex-col gap-3">
          <button
            ...
            className="w-full rounded-2xl px-6 py-4 text-xl font-extrabold tracking-wide 
              shadow-[inset_0_-4px_0_rgba(0,0,0,.2)] disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
          ...
          <button
            ...
            disabled={!connected}
            className="w-full rounded-2xl border-2 border-rose-800/80 bg-gradient-to-b from-rose-500 to-rose-700 
              px-6 py-3 font-extrabold text-white shadow-[inset_0_-3px_0_rgba(0,0,0,.3)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Desconectar
          </button>
        </div>
      ...
      <div className="rounded-2xl border-4 border-[#0c1c36] 
        ...
        <button
          ...
          disabled={!logged?.id}
          className="mt-5 w-full rounded-2xl px-6 py-4 text-xl font-extrabold tracking-wide 
            shadow-[inset_0_-4px_0_rgba(0,0,0,.2)] disabled:opacity-50 disabled:cursor-not-allowed"
          style={{
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 rounded-xl bg-[#0a1a32] border-2 border-[#1f3359] 
              text-sky-200 px-4 py-3 tracking-widest text-center">
              {createdCode ?? "—"}
            </div>
          </div>
        </div>
